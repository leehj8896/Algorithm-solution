...
bool Game::checkGoal(int y, int x)
{
    for (int i = 0; i < goalPositions[currentStage].size(); i++)
...
//빈칸으로 한 칸 앞으로 가는 함수
void Game::walk(int y, int x, int nextY, int nextX)
{
...
void Game::push(int y, int x, int nextY, int nextX, int afterY, int afterX)
{
